...
<main class="w-whead mx-auto pb-10 xl:w-[1600px] mm:w-[1400px] lg:w-[1150px] md:w-[768px]">
    <div class="text-black dark:text-white w-[500px] mx-[550px]">
        <h1 class="text-3xl">Добавить жанр:</h1>
        <form action="/addgenres" method="post" enctype="multipart/form-data">
            ...
            <div class="flex space-x-5 pt-4 justify-between">
                <div class="w-[200px]">
                    ...
                    <input class="w-[220px] px-2 py-1 text-black rounded-md border-2 border-black dark:border-white" type="file" name="img">
                </div>
            </div>
            <div class="flex space-x-5 pt-4 justify-between">
                <div class="text-xl">
