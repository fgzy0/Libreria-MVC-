    ...
    <header class="pt-2 w-whead mx-auto 2xl:w-[1520px] xl:w-[1264px]">
        <div class="flex pt-big items-center justify-between px-4 2xl:px-0 xl:px-0 lg:px-0 md:px-0">
            <span class="font-bold text-3xl">
                <a href="/"><img class="w-auto h-12" src="/public/images/header/logotip.png"></a>
            </span>
            <div class="items-center">
              <form class="flex items-center 2xl:w-auto xl:w-auto lg:w-auto md:w-auto w-0 2xl:visible xl:visible lg:visible md:visible invisible">   
                ...
                <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-[#4d94a0] bg-blue-700 rounded-lg border border-[#4d94a0] hover:bg-[#4d94a0] hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div class="border-2 2xl:h-auto xl:h-auto lg:h-auto md:h-auto h-0 2xl:w-auto xl:w-auto lg:w-auto md:w-auto w-0">
            ...
            <ul class="menu-2 absolute left-4 right-6 top-24 pt-0 bg-white text-black h-auto w-auto flex flex-col items-center rounded-md shadow-2xl">
